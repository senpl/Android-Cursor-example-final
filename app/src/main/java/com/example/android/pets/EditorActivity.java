...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        String[] columnsAreCalledProjection = new String[]{PetEntry._ID, PetEntry.COLUMN_PET_NAME, PetEntry.COLUMN_PET_BREED,PetEntry.COLUMN_PET_GENDER,PetEntry.COLUMN_PET_WEIGHT};
...
//            String idFromData=uri.toString();
//            idFromData=idFromData.substring(idFromData.lastIndexOf("/")+1);
//            String searchedColumn=PetEntry._ID +" = ?";
//            String[] searchedId={idFromData};
//
//            cursorLoader = new CursorLoader(getBaseContext(), baseUri,
//                    columnsAreCalledProjection, searchedColumn, searchedId, null);
        }
        return cursorLoader;
    }
...
//        mGenderSpinner.getBaseline()
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent sendedIntent=getIntent();
        currentUri=sendedIntent.getData();
...
//        mNameEditText = (EditText) findViewById(R.id.editor_label);
    ...
    private void savePet() {
        ...
        Intent sendedIntent=getIntent();
        Uri currentUri=sendedIntent.getData();
