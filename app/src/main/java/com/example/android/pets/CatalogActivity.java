...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public PetCursorAdapter cursorAdapter;
...
//        petListView.se
        petListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(CatalogActivity.this, EditorActivity.class);
                Uri uri=ContentUris.withAppendedId(PetEntry.CONTENT_URI,id); //Uri.parse(PetContract.BASE_CONTENT_URI+PetContract.CONTENT_AUTHORITY+PetContract.PATH_PETS);
                intent.setData(uri);
                startActivity(intent);
            }
        });
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        String[] columns=new String[]{PetEntry._ID,PetEntry.COLUMN_PET_NAME,PetEntry.COLUMN_PET_BREED};
